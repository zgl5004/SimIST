 ...
 */
    public class JFrameOne extends JFrame {
      ...
      public JFrameOne() 
        ...
        this.image1= new ImageIcon("src/entities/table.jpg");
        this.ImageSize = image1.getIconWidth();
        this.Aimage = image1.getImage().getScaledInstance(100,100, Image.SCALE_DEFAULT);
